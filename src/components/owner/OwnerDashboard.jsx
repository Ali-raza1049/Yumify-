  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <Link to="/manage-order" className="flex items-center justify-center gap-2 border py-3 rounded-xl hover:bg-gray-100">
          <ClipboardList size={18} />
          View All Orders
        </Link>

        <Link to="/manage-user" className="flex items-center justify-center gap-2 border py-3 rounded-xl hover:bg-gray-100">
          <UserCog size={18} />
          Manage Users
        </Link>
      </div>
